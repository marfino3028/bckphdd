...
class DashboardController extends BaseController
{
    public function dataGet(Request $request){
        ...
        // $disEstimates   = Estimates::orderBy('estimates_date', 'ASC')->get('estimates_date');
